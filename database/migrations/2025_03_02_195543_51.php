...
return new class extends Migration
{
    ...
    {
        Schema::create('51_mahasiswa', function (Blueprint $table) {
        ...
        Schema::create('51_riwayat_kawe', function (Blueprint $table) {
            $table->id();
            $table->string('nim_id')->nullable();
            $table->foreign('nim_id')->references('nim')->on('51_mahasiswa')->onDelete('cascade');
        ...
        Schema::create('51_riwayat_matakuliah', function (Blueprint $table) {
            $table->id();
            $table->string('nim_id')->nullable();
            $table->foreign('nim_id')->references('nim')->on('51_mahasiswa')->onDelete('cascade');

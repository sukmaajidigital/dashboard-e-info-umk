...
return new class extends Migration
{
    ...
    {
        Schema::create('03_mahasiswa', function (Blueprint $table) {
        ...
        Schema::create('03_riwayat_kawe', function (Blueprint $table) {
            $table->id();
            $table->string('nim_id')->nullable();
            $table->foreign('nim_id')->references('nim')->on('03_mahasiswa')->onDelete('cascade');
        ...
        Schema::create('03_riwayat_matakuliah', function (Blueprint $table) {
            $table->id();
            $table->string('nim_id')->nullable();
            $table->foreign('nim_id')->references('nim')->on('03_mahasiswa')->onDelete('cascade');

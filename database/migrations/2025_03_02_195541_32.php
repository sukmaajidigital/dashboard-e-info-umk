...
return new class extends Migration
{
    ...
    {
        Schema::create('32_mahasiswa', function (Blueprint $table) {
        ...
        Schema::create('32_riwayat_kawe', function (Blueprint $table) {
            $table->id();
            $table->string('nim_id')->nullable();
            $table->foreign('nim_id')->references('nim')->on('32_mahasiswa')->onDelete('cascade');
        ...
        Schema::create('32_riwayat_matakuliah', function (Blueprint $table) {
            $table->id();
            $table->string('nim_id')->nullable();
            $table->foreign('nim_id')->references('nim')->on('32_mahasiswa')->onDelete('cascade');

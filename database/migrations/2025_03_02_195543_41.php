...
return new class extends Migration
{
    ...
    {
        Schema::create('41_mahasiswa', function (Blueprint $table) {
        ...
        Schema::create('41_riwayat_kawe', function (Blueprint $table) {
            $table->id();
            $table->string('nim_id')->nullable();
            $table->foreign('nim_id')->references('nim')->on('41_mahasiswa')->onDelete('cascade');
        ...
        Schema::create('41_riwayat_matakuliah', function (Blueprint $table) {
            $table->id();
            $table->string('nim_id')->nullable();
            $table->foreign('nim_id')->references('nim')->on('41_mahasiswa')->onDelete('cascade');

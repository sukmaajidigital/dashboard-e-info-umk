...
class Seeder41 extends Seeder
{
    ...
    {
        // Seed 41_mahasiswa
        $mahasiswaData = json_decode(File::get(database_path('json/41/mahasiswa.json')), true);
        foreach ($mahasiswaData as $mahasiswa) {
            DB::table('41_mahasiswa')->insert([
                'nim' => $mahasiswa['nim'],
                'nama' => $mahasiswa['nama'],
        ...
        // // Seed 41_riwayat_kawe
        // $riwayatKaweData = json_decode(File::get(database_path('json/41/riwayat_kawe.json')), true);
        // foreach ($riwayatKaweData as $riwayat) {
        //     DB::table('41_riwayat_kawe')->insert([
        //         'nim_id' => $riwayat['nim'],
        ...
        // // Seed 41_riwayat_matakuliah
        // $riwayatMatakuliahData = json_decode(File::get(database_path('json/41/riwayat_matakuliah.json')), true);
        ...
        //     if ($matakuliahExists) {
        //         DB::table('41_riwayat_matakuliah')->insert([
        //             'nim_id' => $riwayat['nim'],

...
class Seeder11 extends Seeder
{
    ...
    {
        // Seed 11_mahasiswa
        $mahasiswaData = json_decode(File::get(database_path('json/11/mahasiswa.json')), true);
        foreach ($mahasiswaData as $mahasiswa) {
            DB::table('11_mahasiswa')->insert([
                'nim' => $mahasiswa['nim'],
                'nama' => $mahasiswa['nama'],
        ...
        // Seed 11_riwayat_kawe
        $riwayatKaweData = json_decode(File::get(database_path('json/11/riwayat_kawe.json')), true);
        foreach ($riwayatKaweData as $riwayat) {
            DB::table('11_riwayat_kawe')->insert([
                'nim_id' => $riwayat['nim'],
        ...
        // Seed 11_riwayat_matakuliah
        $riwayatMatakuliahData = json_decode(File::get(database_path('json/11/riwayat_matakuliah.json')), true);
        foreach ($riwayatMatakuliahData as $riwayat) {
            ...
            if ($matakuliahExists) {
                DB::table('11_riwayat_matakuliah')->insert([
                    'nim_id' => $riwayat['nim'],

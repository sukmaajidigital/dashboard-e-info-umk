...
class Seeder12 extends Seeder
{
    ...
    {
        // Seed 12_mahasiswa
        $mahasiswaData = json_decode(File::get(database_path('json/12/mahasiswa.json')), true);
        foreach ($mahasiswaData as $mahasiswa) {
            DB::table('12_mahasiswa')->insert([
                'nim' => $mahasiswa['nim'],
                'nama' => $mahasiswa['nama'],
        ...
        // Seed 12_riwayat_kawe
        $riwayatKaweData = json_decode(File::get(database_path('json/12/riwayat_kawe.json')), true);
        foreach ($riwayatKaweData as $riwayat) {
            DB::table('12_riwayat_kawe')->insert([
                'nim_id' => $riwayat['nim'],
        ...
        // Seed 12_riwayat_matakuliah
        $riwayatMatakuliahData = json_decode(File::get(database_path('json/12/riwayat_matakuliah.json')), true);
        foreach ($riwayatMatakuliahData as $riwayat) {
            ...
            if ($matakuliahExists) {
                DB::table('12_riwayat_matakuliah')->insert([
                    'nim_id' => $riwayat['nim'],

...
class Seeder34 extends Seeder
{
    ...
    {
        // Seed 34_mahasiswa
        $mahasiswaData = json_decode(File::get(database_path('json/34/mahasiswa.json')), true);
        foreach ($mahasiswaData as $mahasiswa) {
            DB::table('34_mahasiswa')->insert([
                'nim' => $mahasiswa['nim'],
                'nama' => $mahasiswa['nama'],
        ...
        // Seed 34_riwayat_kawe
        // $riwayatKaweData = json_decode(File::get(database_path('json/34/riwayat_kawe.json')), true);
        // foreach ($riwayatKaweData as $riwayat) {
        //     DB::table('34_riwayat_kawe')->insert([
        //         'nim_id' => $riwayat['nim'],
        ...
        // // Seed 34_riwayat_matakuliah
        // $riwayatMatakuliahData = json_decode(File::get(database_path('json/34/riwayat_matakuliah.json')), true);
        ...
        //     if ($matakuliahExists) {
        //         DB::table('34_riwayat_matakuliah')->insert([
        //             'nim_id' => $riwayat['nim'],

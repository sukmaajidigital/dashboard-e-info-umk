...
class Seeder04 extends Seeder
{
    ...
    {
        // Seed 04_mahasiswa
        $mahasiswaData = json_decode(File::get(database_path('json/04/mahasiswa.json')), true);
        foreach ($mahasiswaData as $mahasiswa) {
            DB::table('04_mahasiswa')->insert([
                'nim' => $mahasiswa['nim'],
                'nama' => $mahasiswa['nama'],
        ...
        // // Seed 04_riwayat_kawe
        // $riwayatKaweData = json_decode(File::get(database_path('json/04/riwayat_kawe.json')), true);
        // foreach ($riwayatKaweData as $riwayat) {
        //     DB::table('04_riwayat_kawe')->insert([
        //         'nim_id' => $riwayat['nim'],
        ...
        // // Seed 04_riwayat_matakuliah
        // $riwayatMatakuliahData = json_decode(File::get(database_path('json/04/riwayat_matakuliah.json')), true);
        ...
        //     if ($matakuliahExists) {
        //         DB::table('04_riwayat_matakuliah')->insert([
        //             'nim_id' => $riwayat['nim'],

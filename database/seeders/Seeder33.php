...
class Seeder33 extends Seeder
{
    ...
    {
        // Seed 33_mahasiswa
        $mahasiswaData = json_decode(File::get(database_path('json/33/mahasiswa.json')), true);
        foreach ($mahasiswaData as $mahasiswa) {
            DB::table('33_mahasiswa')->insert([
                'nim' => $mahasiswa['nim'],
                'nama' => $mahasiswa['nama'],
        ...
        // Seed 33_riwayat_kawe
        $riwayatKaweData = json_decode(File::get(database_path('json/33/riwayat_kawe.json')), true);
        foreach ($riwayatKaweData as $riwayat) {
            DB::table('33_riwayat_kawe')->insert([
                'nim_id' => $riwayat['nim'],
        ...
        // Seed 33_riwayat_matakuliah
        $riwayatMatakuliahData = json_decode(File::get(database_path('json/33/riwayat_matakuliah.json')), true);
        foreach ($riwayatMatakuliahData as $riwayat) {
            ...
            if ($matakuliahExists) {
                DB::table('33_riwayat_matakuliah')->insert([
                    'nim_id' => $riwayat['nim'],

...
class Seeder52 extends Seeder
{
    ...
    {
        // Seed 52_mahasiswa
        $mahasiswaData = json_decode(File::get(database_path('json/52/mahasiswa.json')), true);
        foreach ($mahasiswaData as $mahasiswa) {
            DB::table('52_mahasiswa')->insert([
                'nim' => $mahasiswa['nim'],
                'nama' => $mahasiswa['nama'],
        ...
        // // Seed 52_riwayat_kawe
        // $riwayatKaweData = json_decode(File::get(database_path('json/52/riwayat_kawe.json')), true);
        // foreach ($riwayatKaweData as $riwayat) {
        //     DB::table('52_riwayat_kawe')->insert([
        //         'nim_id' => $riwayat['nim'],
        ...
        // // Seed 52_riwayat_matakuliah
        // $riwayatMatakuliahData = json_decode(File::get(database_path('json/52/riwayat_matakuliah.json')), true);
        ...
        //     if ($matakuliahExists) {
        //         DB::table('52_riwayat_matakuliah')->insert([
        //             'nim_id' => $riwayat['nim'],

...
class Seeder32 extends Seeder
{
    ...
    {
        // Seed 32_mahasiswa
        $mahasiswaData = json_decode(File::get(database_path('json/32/mahasiswa.json')), true);
        foreach ($mahasiswaData as $mahasiswa) {
            DB::table('32_mahasiswa')->insert([
                'nim' => $mahasiswa['nim'],
                'nama' => $mahasiswa['nama'],
        ...
        // // Seed 32_riwayat_kawe
        // $riwayatKaweData = json_decode(File::get(database_path('json/32/riwayat_kawe.json')), true);
        // foreach ($riwayatKaweData as $riwayat) {
        //     DB::table('32_riwayat_kawe')->insert([
        //         'nim_id' => $riwayat['nim'],
        ...
        // // Seed 32_riwayat_matakuliah
        // $riwayatMatakuliahData = json_decode(File::get(database_path('json/32/riwayat_matakuliah.json')), true);
        ...
        //     if ($matakuliahExists) {
        //         DB::table('32_riwayat_matakuliah')->insert([
        //             'nim_id' => $riwayat['nim'],

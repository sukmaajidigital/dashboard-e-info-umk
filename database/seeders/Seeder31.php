...
class Seeder31 extends Seeder
{
    ...
    {
        // Seed 31_mahasiswa
        $mahasiswaData = json_decode(File::get(database_path('json/31/mahasiswa.json')), true);
        foreach ($mahasiswaData as $mahasiswa) {
            DB::table('31_mahasiswa')->insert([
                'nim' => $mahasiswa['nim'],
                'nama' => $mahasiswa['nama'],
        ...
        // // Seed 31_riwayat_kawe
        // $riwayatKaweData = json_decode(File::get(database_path('json/31/riwayat_kawe.json')), true);
        // foreach ($riwayatKaweData as $riwayat) {
        //     DB::table('31_riwayat_kawe')->insert([
        //         'nim_id' => $riwayat['nim'],
        ...
        // // Seed 31_riwayat_matakuliah
        // $riwayatMatakuliahData = json_decode(File::get(database_path('json/31/riwayat_matakuliah.json')), true);
        ...
        //     if ($matakuliahExists) {
        //         DB::table('31_riwayat_matakuliah')->insert([
        //             'nim_id' => $riwayat['nim'],

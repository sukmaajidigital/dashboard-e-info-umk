...
class Seeder20 extends Seeder
{
    ...
    {
        // Seed 20_mahasiswa
        $mahasiswaData = json_decode(File::get(database_path('json/20/mahasiswa.json')), true);
        foreach ($mahasiswaData as $mahasiswa) {
            DB::table('20_mahasiswa')->insert([
                'nim' => $mahasiswa['nim'],
                'nama' => $mahasiswa['nama'],
        ...
        // // Seed 20_riwayat_kawe
        // $riwayatKaweData = json_decode(File::get(database_path('json/20/riwayat_kawe.json')), true);
        // foreach ($riwayatKaweData as $riwayat) {
        //     DB::table('20_riwayat_kawe')->insert([
        //         'nim_id' => $riwayat['nim'],
        ...
        // // Seed 20_riwayat_matakuliah
        // $riwayatMatakuliahData = json_decode(File::get(database_path('json/20/riwayat_matakuliah.json')), true);
        ...
        //     if ($matakuliahExists) {
        //         DB::table('20_riwayat_matakuliah')->insert([
        //             'nim_id' => $riwayat['nim'],

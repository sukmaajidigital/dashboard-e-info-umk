...
class Seeder57 extends Seeder
{
    ...
    {
        // Seed 57_mahasiswa
        $mahasiswaData = json_decode(File::get(database_path('json/57/mahasiswa.json')), true);
        foreach ($mahasiswaData as $mahasiswa) {
            DB::table('57_mahasiswa')->insert([
                'nim' => $mahasiswa['nim'],
                'nama' => $mahasiswa['nama'],
        ...
        // Seed 57_riwayat_kawe
        $riwayatKaweData = json_decode(File::get(database_path('json/57/riwayat_kawe.json')), true);
        foreach ($riwayatKaweData as $riwayat) {
            DB::table('57_riwayat_kawe')->insert([
                'nim_id' => $riwayat['nim'],
        ...
        // Seed 57_riwayat_matakuliah
        $riwayatMatakuliahData = json_decode(File::get(database_path('json/57/riwayat_matakuliah.json')), true);
        foreach ($riwayatMatakuliahData as $riwayat) {
            ...
            if ($matakuliahExists) {
                DB::table('57_riwayat_matakuliah')->insert([
                    'nim_id' => $riwayat['nim'],

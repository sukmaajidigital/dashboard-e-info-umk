...
class Seeder53 extends Seeder
{
    ...
    {
        // Seed 53_mahasiswa
        $mahasiswaData = json_decode(File::get(database_path('json/53/mahasiswa.json')), true);
        foreach ($mahasiswaData as $mahasiswa) {
            DB::table('53_mahasiswa')->insert([
                'nim' => $mahasiswa['nim'],
                'nama' => $mahasiswa['nama'],
        ...
        // // Seed 53_riwayat_kawe
        // $riwayatKaweData = json_decode(File::get(database_path('json/53/riwayat_kawe.json')), true);
        // foreach ($riwayatKaweData as $riwayat) {
        //     DB::table('53_riwayat_kawe')->insert([
        //         'nim_id' => $riwayat['nim'],
        ...
        // // Seed 53_riwayat_matakuliah
        // $riwayatMatakuliahData = json_decode(File::get(database_path('json/53/riwayat_matakuliah.json')), true);
        ...
        //     if ($matakuliahExists) {
        //         DB::table('53_riwayat_matakuliah')->insert([
        //             'nim_id' => $riwayat['nim'],

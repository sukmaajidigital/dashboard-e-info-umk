...
class Seeder01 extends Seeder
{
    ...
    {
        // Seed 01_mahasiswa
        $mahasiswaData = json_decode(File::get(database_path('json/01/mahasiswa.json')), true);
        foreach ($mahasiswaData as $mahasiswa) {
            DB::table('01_mahasiswa')->insert([
                'nim' => $mahasiswa['nim'],
                'nama' => $mahasiswa['nama'],
        ...
        // Seed 01_riwayat_kawe
        // $riwayatKaweData = json_decode(File::get(database_path('json/01/riwayat_kawe.json')), true);
        // foreach ($riwayatKaweData as $riwayat) {
        //     DB::table('01_riwayat_kawe')->insert([
        //         'nim_id' => $riwayat['nim'],
        ...
        // // Seed 01_riwayat_matakuliah
        // $riwayatMatakuliahData = json_decode(File::get(database_path('json/01/riwayat_matakuliah.json')), true);
        ...
        //     if ($matakuliahExists) {
        //         DB::table('01_riwayat_matakuliah')->insert([
        //             'nim_id' => $riwayat['nim'],

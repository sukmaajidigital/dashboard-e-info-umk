...
class Seeder54 extends Seeder
{
    ...
    {
        // Seed 54_mahasiswa
        $mahasiswaData = json_decode(File::get(database_path('json/54/mahasiswa.json')), true);
        foreach ($mahasiswaData as $mahasiswa) {
            DB::table('54_mahasiswa')->insert([
                'nim' => $mahasiswa['nim'],
                'nama' => $mahasiswa['nama'],
        ...
        // // Seed 54_riwayat_kawe
        // $riwayatKaweData = json_decode(File::get(database_path('json/54/riwayat_kawe.json')), true);
        // foreach ($riwayatKaweData as $riwayat) {
        //     DB::table('54_riwayat_kawe')->insert([
        //         'nim_id' => $riwayat['nim'],
        ...
        // // Seed 54_riwayat_matakuliah
        // $riwayatMatakuliahData = json_decode(File::get(database_path('json/54/riwayat_matakuliah.json')), true);
        ...
        //     if ($matakuliahExists) {
        //         DB::table('54_riwayat_matakuliah')->insert([
        //             'nim_id' => $riwayat['nim'],
